...
var CityCostComponent = /** @class */ (function () {
    function CityCostComponent() {
        this.data = [
            { label: '梧州', value: 4 },
            { label: '廊坊', value: 4 },
            { label: '淮北', value: 5 },
    ...
    CityCostComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.map(function (item) {
            _this.option.legend.data.push(item.label);
    ...
    CityCostComponent.prototype.onChartInit = function (ev) {
        this.echartInstance = ev;
    };
    CityCostComponent.prototype.onclick = function (city) {
        console.log(city);
    };
    CityCostComponent.prototype.onSelectedCyc = function () { };
...
var ComponentHeaderComponent = /** @class */ (function () {
    ...
    ComponentHeaderComponent.prototype.onClickSet = function (e) {
        this.onSet.emit(e);
    };
    ComponentHeaderComponent.prototype.onClickExpand = function (e) {
    ...
    ComponentHeaderComponent.prototype.ngOnInit = function () {
        ...
        if (this.model && this.model.length > 0) {
            this.model.forEach(function (m) {
                _this.set = m === 'set' ? true : false;
                _this.expand = m === 'expand' ? true : false;
            });
        }
    };
...
var DesktopRoutingModule = /** @class */ (function () {
    function DesktopRoutingModule() {
    }
...
var COMPONENTS = [_main_main_component__WEBPACK_IMPORTED_MODULE_5__["MainComponent"], _component_header_component_header_component__WEBPACK_IMPORTED_MODULE_6__["ComponentHeaderComponent"]];
...
var DesktopModule = /** @class */ (function () {
    ...
    DesktopModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](COMPONENTS, COMPONENTS_NOROUNT, [_city_cost_city_cost_component__WEBPACK_IMPORTED_MODULE_7__["CityCostComponent"], _shop_view_shop_view_component__WEBPACK_IMPORTED_MODULE_8__["ShopViewComponent"], _top_prod_top_prod_component__WEBPACK_IMPORTED_MODULE_9__["TopProdComponent"]]),
...
var ShopViewComponent = /** @class */ (function () {
    function ShopViewComponent() {
        ...
        src_assets_data_shop_pay__WEBPACK_IMPORTED_MODULE_3__["PayData"].map(function (item) {
            _this.option.dataset[1].source.push({
                x: item.time, y: item.count
            });
        });
        src_assets_data_shop_view__WEBPACK_IMPORTED_MODULE_2__["ViewData"].map(function (item) {
            _this.option.dataset[0].source.push({
                x: item.time, y: item.count
            });
        });
    }
    ShopViewComponent.prototype.ngOnInit = function () {
    };
    ShopViewComponent.prototype.onChartInit = function (ec) {
    };
...
var TopProdComponent = /** @class */ (function () {
    function TopProdComponent() {
        var _this = this;
        this.option = {
            title: {
                text: '商店人员消费'
        ...
        src_assets_data_cate_name__WEBPACK_IMPORTED_MODULE_2__["CateData"].map(function (item) {
            _this.rankingListData.push({
                title: item.shop_id + "-" + item.cate_name,
                total: item.pay_c
            });
            _this.option.xAxis[0].data.push(item.shop_id);
            _this.option.series[0].data.push(item.per_pay);
            _this.option.series[1].data.push(item.pay_c);
        });
    }
    TopProdComponent.prototype.ngOnInit = function () {
    };
    TopProdComponent.prototype.onChartInit = function (ec) {
    };
...
var v = [{ count: 66, time: '2015/06/26' },
...
var v = [{ count: 42244, time: '2016/06/22' },
...
//# sourceMappingURL=desktop-desktop-module-es5.js.map