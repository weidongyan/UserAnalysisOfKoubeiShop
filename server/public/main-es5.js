...
var map = {
	...
	"./his/his.module": [
		...
		"default~desktop-desktop-module~his-his-module~spark-rdd-spark-rdd-module~spark-stream-sparkstream-mo~b5e78336",
		"default~desktop-desktop-module~his-his-module~spark-rdd-spark-rdd-module~user-user-module",
		"default~his-his-module~spark-rdd-spark-rdd-module~spark-stream-sparkstream-module~user-user-module",
		"common",
		"his-his-module"
	],
...
function getRule(params) {
    var ret = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](list);
    if (params.sorter) {
...
var I18NSERVICE_PROVIDES = [{ provide: _delon_theme__WEBPACK_IMPORTED_MODULE_7__["ALAIN_I18N_TOKEN"], useClass: _core__WEBPACK_IMPORTED_MODULE_11__["I18NService"], multi: false }];
// #endregion
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](LANG_PROVIDES, INTERCEPTOR_PROVIDES, I18NSERVICE_PROVIDES, APPINIT_PROVIDES),
...
/*!*******************************!*\
  !*** ./src/app/core/index.ts ***!
  \*******************************/
/*! exports provided: throwIfAlreadyLoaded, I18NService, DefaultInterceptor, StartupService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var StartupService = /** @class */ (function () {
    function StartupService(iconSrv, menuService, translate, i18n, settingService, aclService, titleService, httpClient) {
        ...
        iconSrv.addIcon.apply(iconSrv, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_style_icons_auto__WEBPACK_IMPORTED_MODULE_10__["ICONS_AUTO"], _style_icons__WEBPACK_IMPORTED_MODULE_11__["ICONS"]));
    }
    StartupService.prototype.load = function () {
        ...
        return new Promise(function (resolve) {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["zip"])(_this.httpClient.get("assets/tmp/i18n/" + _this.i18n.defaultLang + ".json"), _this.httpClient.get('assets/tmp/app-menu.json'))
                .pipe(
            // 接收其他拦截器后产生的异常消息
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (_a) {
                var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), langData = _b[0], appData = _b[1];
                resolve(null);
...
var MOCK_MODULES = true ? [_delon_mock__WEBPACK_IMPORTED_MODULE_5__["DelonMockModule"].forRoot({ data: _mock__WEBPACK_IMPORTED_MODULE_6__ })] : undefined;
...
var DelonModule = /** @class */ (function () {
    ...
    DelonModule.forRoot = function () {
        return {
            ...
            providers: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](REUSETAB_PROVIDES, GLOBAL_CONFIG_PROVIDES),
        };
    };
    var DelonModule_1;
    ...
    DelonModule = DelonModule_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"]([_delon_theme__WEBPACK_IMPORTED_MODULE_3__["AlainThemeModule"].forRoot(), _delon_acl__WEBPACK_IMPORTED_MODULE_4__["DelonACLModule"].forRoot()], MOCK_MODULES),
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"])()), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["SkipSelf"])()),
...
var COMPONENTS = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"]([
...
var LayoutModule = /** @class */ (function () {
    ...
    LayoutModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](COMPONENTS, HEADERCOMPONENTS, PASSPORT),
            exports: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](COMPONENTS, PASSPORT),
        })
    ], LayoutModule);
    return LayoutModule;
}());
...
var DashboardMonitorComponent = /** @class */ (function () {
    ...
    DashboardMonitorComponent.prototype.ngOnInit = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["zip"])(this.http.get('/chart'), this.http.get('/chart/tags')).subscribe(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), res = _b[0], tags = _b[1];
            _this.data = res;
    ...
    DashboardMonitorComponent.prototype.refData = function () {
        ...
        // stat
        this.activeStat.max = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](activeData).sort()[activeData.length - 1].y + 200;
        this.activeStat.min = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](activeData).sort()[Math.floor(activeData.length / 2)].y;
...
var DashboardWorkplaceComponent = /** @class */ (function () {
    ...
    DashboardWorkplaceComponent.prototype.ngOnInit = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["zip"])(this.http.get('/chart'), this.http.get('/api/notice'), this.http.get('/api/activities')).subscribe(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 3), chart = _b[0], notice = _b[1], activities = _b[2];
...
var JsonSchemaModule = /** @class */ (function () {
    ...
    JsonSchemaModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            exports: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](SCHEMA_THIRDS_COMPONENTS),
        }),
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](COMPONENTS, DIRECTIVES),
