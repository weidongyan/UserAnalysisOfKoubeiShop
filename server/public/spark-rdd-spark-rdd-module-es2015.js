...
let LiucunComponent = class LiucunComponent {
    constructor() {
...
let SparkRddRoutingModule = class SparkRddRoutingModule {
};
...
let TopComponent = class TopComponent {
    ...
    ngOnInit() {
        src_assets_data_top_spark__WEBPACK_IMPORTED_MODULE_2__["topspark"].map(item => {
...
let Top50Component = class Top50Component {
    constructor() {
        this.columns = [
            { header: '序号', field: 'xh' },
...
let ViewComponent = class ViewComponent {
    constructor() {
        ...
        src_assets_data_view_day__WEBPACK_IMPORTED_MODULE_2__["viewday"].map(item => {
            this.option_day.dataset[0].source.push({ x: item.timeStr, y: item.viewCount });
        });
        src_assets_data_view_weak__WEBPACK_IMPORTED_MODULE_3__["viewweek"].map(item => {
            this.option_week.dataset[0].source.push({ x: item.weekOfYear, y: item.viewCount });
        });
        src_assets_data_view_mont__WEBPACK_IMPORTED_MODULE_4__["viewmonth"].map(item => {
...
const v = [{ "shopId": "1629", "avgPerDayPayCount": 41874 },
...
const v = [{ "timeStr": "2016-10", "viewCount": 374 },
...
const v = [{ "year": "2016", "weekOfYear": 44, "viewCount": 8 },
...
//# sourceMappingURL=spark-rdd-spark-rdd-module-es2015.js.map